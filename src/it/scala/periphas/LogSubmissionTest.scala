...
import periphas.base.IntegrationTestBase
import com.twitter.finagle.http
import org.scalatest.concurrent.ScalaFutures
import periphas.utils.TwitterFutures
...
//      When("""I do a POST with {"logline" : "some action took 101 seconds", "metric-key" :
//         "a-numerical-metric"} to /components/parsConfigComp/logs on the """ +
//          "LogReceiver port")
